...
public class test3{
    public static void main(String[] args) {
        ...
        System.out.println("\n\n");
        System.out.println("\t\t\t 0. Search Record");
        System.out.println("\t\t\t 1. Add    Records");
        System.out.println("\t\t\t 2. List roll no's");
        ...
        while(choice!=5){
            switch (choice) {
                ...
                case '1':
                    ...
                    n = scanner.nextInt();
                    tree.Insert(key, new Student(n,s));
                    break;
                case '2':
                    tree.Show();
                    break;
                case '3':
                    ...
                    if (tree.Search(key) == null) {
                        System.out.println("Student's data with this roll no. is not present in the database");
                    } else {
